...
public class CategoryController {
    ...
    public String add(@Valid @ModelAttribute("categoryNew") Category category, BindingResult bindingResult, RedirectAttributes attributes){
    ...
    public String update(Category category, RedirectAttributes attributes) {
        try {
            ...
            e.printStackTrace();
            attributes.addFlashAttribute("error", "Failed to updating for duplicate name");
        }catch (Exception e){
            e.printStackTrace();
            attributes.addFlashAttribute("error", "Error Server");
        }
