...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    @Override
    public ShoppingCart addItemToCart(Product product, Integer quantity, Customer customer) {
    ...
    @Override
    public ShoppingCart updateItemInCart(Product product, Integer quantity, Customer customer) {
        ShoppingCart cart = customer.getShoppingCart();
